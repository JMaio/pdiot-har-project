      ...
      request = new GetRequest(url, headers, null, stringRequest, errorListener);
       ...
       if (formParamStr != null) {
          ...
          request = new PostRequest(url, headers, null, (HttpEntity) body, stringRequest, errorListener);
            ...
            // modified to make requests always have json content type
             request = new PostRequest(url, headers, contentType, new StringEntity(serialize(body), ContentType.create(ContentType.APPLICATION_JSON.getMimeType(), "UTF-8")), stringRequest, errorListener);
          }
       } else {
